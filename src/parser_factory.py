import argparse
from .arguments import STANDARD_CLI, REMOTE_CLI
from .subcommand_funcs import start
...
class ArgumentParser(argparse.ArgumentParser):
    def __init__(self, client: str = 'standard', *args, **kwargs):
        ...
        if self.client == 'remote':
            ...
            self.add_argument('-h','--help', action='help_str', help='Return this help message.', dest='returns')
